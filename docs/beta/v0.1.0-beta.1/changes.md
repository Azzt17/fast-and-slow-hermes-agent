...
| BETA-001 | 2026-07-29 | data/config | working tree | ADR-0016 | 48-query PASS; unit 60 PASS | clean-start verified | active |
| BETA-002 | 2026-07-29 | config | working tree | ADR-0016 | profile isolation + model smoke PASS | clean-start verified | active |
